...
export const translations = {
  fr: {
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Site Web', tag: 'WEB', delivery: '2–3 semaines', features: ['Landing page ou site multi-pages', 'Rapide sur mobile, visible sur Google', 'Sur-mesure, jamais un template'] },
        { name: 'Application Mobile', tag: 'iOS · ANDROID', delivery: '6–10 semaines', features: ['iOS + Android depuis une seule base de code', 'Publication Google Play / App Store incluse', 'Maintenance et mises à jour'] },
        { name: 'Système Assisté par IA', tag: 'SUR-MESURE', delivery: 'Selon le périmètre', features: ['Moteurs qui automatisent le travail manuel', 'Intégration à vos outils existants', 'Accompagnement de bout en bout'] },
      ],
    },
  ...
  en: {
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Website', tag: 'WEB', delivery: '2–3 weeks', features: ['Landing page or multi-page site', 'Fast on mobile, visible on Google', 'Custom-built, never a template'] },
        { name: 'Mobile App', tag: 'iOS · ANDROID', delivery: '6–10 weeks', features: ['iOS + Android from one codebase', 'Google Play / App Store publishing included', 'Maintenance and updates'] },
        { name: 'AI-Powered System', tag: 'CUSTOM', delivery: 'Scope-dependent', features: ['Engines that automate manual work', 'Integrates with the tools you already use', 'End-to-end guidance'] },
      ],
    },
